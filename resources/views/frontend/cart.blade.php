    ...
    <nav class="breadcrumb-nav">
        <div class="container">
            <ul class="breadcrumb shop-breadcrumb bb-no">
                <li class="active"><a href="{{ route('frontend.cart') }}">Shopping Cart</a></li>
                <li><a href="{{ route('frontend.checkout') }}">Checkout</a></li>
                <li><a href="{{ route('frontend.order') }}">Order Complete</a></li>
            </ul>
        </div>
    </nav>
    <!-- End of Breadcrumb -->
        ...
        <div class="container">
            <div class="row gutter-lg mb-10">
                ...
                <div class="col-lg-4 sticky-sidebar-wrapper">
                    <div class="pin-wrapper" style="height: 791.359px;"><div class="sticky-sidebar" style="border-bottom: 0px none rgb(102, 102, 102); width: 393.312px;">
