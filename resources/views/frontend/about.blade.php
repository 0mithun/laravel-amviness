    ...
    <div class="page-content">
        <div class="container">
            <section class="introduce mb-10 pb-10">
                ...
                <figure class="br-lg">
                    <img src="{{ asset('frontend') }}/assets/images/pages/about_us/1.jpg" alt="Banner" width="1240" height="540" style="background-color: #D0C1AE;">
                </figure>
            </section>
            ...
            <section class="customer-service mb-7">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 mb-8">
                        <figure class="br-lg">
                            <img src="{{ asset('frontend') }}/assets/images/pages/about_us/2.jpg" alt="Banner" width="610" height="500" style="background-color: #CECECC;">
                        </figure>
                    </div>
                </div>
            </section>
            ...
            <section class="count-section mb-10 pb-5">
                <div class="swiper-container swiper-theme swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events" data-swiper-options="{
                    ...
                    <div class="swiper-wrapper " id="swiper-wrapper-8656875b8f893ca3" aria-live="polite">
                        <div class="swiper-slide counter-wrap swiper-slide-active" role="group" aria-label="1 / 3" style="width: 413.333px;">
                        ...
                        <div class="swiper-slide counter-wrap swiper-slide-next" role="group" aria-label="2 / 3" style="width: 413.333px;">
                            <div class="counter text-center">
                                <span>$</span>
                        ...
                        <div class="swiper-slide counter-wrap" role="group" aria-label="3 / 3" style="width: 413.333px;">
                            <div class="counter text-center">
        ...
        <section class="boost-section pt-10 pb-10">
            <div class="container mt-10 mb-9">
                <div class="row align-items-center mb-10">
                    <div class="col-md-6 mb-8">
                        <figure class="br-lg">
                            <img src="{{ asset('frontend') }}/assets/images/pages/about_us/3.jpg" alt="Banner" width="610" height="450" style="background-color: #9E9DA2;">
                        </figure>
                    </div>
                ...
                {{-- <div class="awards-wrapper">
                    ...
                    <div class="swiper-container swiper-theme swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events" data-swiper-options="{
                        ...
                        <div class="swiper-wrapper " id="swiper-wrapper-3f201aef7109af8d5" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                            <div class="swiper-slide image-box-wrapper swiper-slide-active" role="group" aria-label="1 / 4" style="width: 295px; margin-right: 20px;">
                                <div class="image-box text-center">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/assets/images/pages/about_us/1.png" alt="Award Image" width="109" height="105">
                                    </figure>
                                    <p>Winner Seo Master MAGT<br>
                                        Smart Start Award 2018</p>
                                </div>
                            </div>
                            <div class="swiper-slide image-box-wrapper swiper-slide-next" role="group" aria-label="2 / 4" style="width: 295px; margin-right: 20px;">
                                <div class="image-box text-center">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/assets/images/pages/about_us/2.png" alt="Award Image" width="109" height="105">
                                    </figure>
                                    <p>Top Social Media Agencies<br>
                                        Next Partner 2019</p>
                                </div>
                            </div>
                            <div class="swiper-slide image-box-wrapper mt-3" role="group" aria-label="3 / 4" style="width: 295px; margin-right: 20px;">
                                <div class="image-box text-center">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/assets/images/pages/about_us/3.png" alt="Award Image" width="109" height="105">
                                    </figure>
                                    <p>5 Fastest Growing Abstract<br>
                                        Solution Providers 2020</p>
                                </div>
                            </div>
                            <div class="swiper-slide image-box-wrapper" role="group" aria-label="4 / 4" style="width: 295px; margin-right: 20px;">
                                <div class="image-box text-center">
                                    <figure>
                                        <img src="{{ asset('frontend') }}/assets/images/pages/about_us/4.png" alt="Award Image" width="109" height="105">
                                    </figure>
        ...
        <section class="member-section mt-10 pt-9 mb-10 pb-4">
            <div class="container">
                ...
                <div class="swiper-container swiper-theme swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events" data-swiper-options="{
                    ...
                    <div class="swiper-wrapper " id="swiper-wrapper-4fbff885751b6ffa" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                        <div class="swiper-slide member-wrap swiper-slide-active" role="group" aria-label="1 / 4" style="width: 295px; margin-right: 20px;">
                            <figure class="br-lg">
                                <img src="{{ asset('frontend') }}/assets/images/pages/about_us/4.jpg" alt="Member" width="295" height="332">
                                <div class="overlay">
                        ...
                        <div class="swiper-slide member-wrap swiper-slide-next" role="group" aria-label="2 / 4" style="width: 295px; margin-right: 20px;">
                            <figure class="br-lg">
                                <img src="{{ asset('frontend') }}/assets/images/pages/about_us/5.jpg" alt="Member" width="295" height="332">
                                <div class="overlay">
                                    <div class="social-icons">
                                        <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                                        <a href="#" class="social-icon social-twitter w-icon-twitter"></a>
                        ...
                        <div class="swiper-slide member-wrap" role="group" aria-label="3 / 4" style="width: 295px; margin-right: 20px;">
                            <figure class="br-lg">
                                <img src="{{ asset('frontend') }}/assets/images/pages/about_us/6.jpg" alt="Member" width="295" height="332">
                                <div class="overlay">
                                    <div class="social-icons">
                                        <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                                        <a href="#" class="social-icon social-twitter w-icon-twitter"></a>
                        ...
                        <div class="swiper-slide member-wrap" role="group" aria-label="4 / 4" style="width: 295px; margin-right: 20px;">
                            <figure class="br-lg">
                                <img src="{{ asset('frontend') }}/assets/images/pages/about_us/7.jpg" alt="Member" width="295" height="332">
                                <div class="overlay">
                                    <div class="social-icons">
                                        <a href="#" class="social-icon social-facebook w-icon-facebook"></a>
                                        <a href="#" class="social-icon social-twitter w-icon-twitter"></a>
