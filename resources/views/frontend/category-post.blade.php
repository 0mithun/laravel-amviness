...
<main class="main">
    ...
    <div class="page-header">
        <div class="container">
            <h1 class="page-title mb-0">List</h1>
        </div>
    </div>
    <!-- End of Page Header -->
                ...
                <div class="main-content">
                    ...
                    <article class="post post-list post-listing mb-md-10 mb-6 pb-2 overlay-zoom mb-4">
                        <figure class="post-media br-sm">
                            <a href="{{ route('frontend.singleblog',$post->id) }}">
                                <img src=" {{ asset($post->image) }} " width="930" height="500" alt="blog">
                            </a>
                        </figure>
                        <div class="post-details">
                            ...
                            <h4 class="post-title">
                                <a href="{{ route('frontend.singleblog',$post->id) }}"> {{ $post->title }} </a>
                            </h4>
                            <div class="post-content">
                                <p> {{ Str::limit($post->description, 100) }} </p>
                                <a href="{{ route('frontend.singleblog',$post->id) }}" class="btn btn-link btn-primary">(read more)</a>
                            </div>
                            <div class="post-meta">
                                ...
                                <div class="widget-body">
                                    <div class="swiper">
                                        <div class="swiper-container swiper-theme nav-top swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events" data-swiper-options="{
                                            ...
                                            <div class="swiper-wrapper " id="swiper-wrapper-93ab0e10ca7ccfbfc" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                            ...
                                            <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-93ab0e10ca7ccfbfc" aria-disabled="false"></div>
                                            <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-93ab0e10ca7ccfbfc" aria-disabled="true"></div>
