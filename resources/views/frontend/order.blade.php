    ...
    <nav class="breadcrumb-nav">
        <div class="container">
            <ul class="breadcrumb shop-breadcrumb bb-no">
                <li class="passed"><a href="{{ route('frontend.cart') }}">Shopping Cart</a></li>
                <li class="passed"><a href="{{ route('frontend.checkout') }}">Checkout</a></li>
                <li class="active"><a href="{{ route('frontend.order') }}">Order Complete</a></li>
            </ul>
        </div>
    </nav>
    <!-- End of Breadcrumb -->
