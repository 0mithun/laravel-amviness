...
@section('title') Edit Member | Admin @endsection
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="line-height: 36px;">Edit Member</h3>
                ...
                <div class="row pt-3 pb-3">
                   <div class="col-6 offset-3">
                    <div class="text-center">
                        @if ($team->image)
                            <img class="rounded" id="image" width="150px" height="150px" src=" {{ asset($team->image) }}" alt="user image" style="border: 1px solid #adb5bd;margin: 0 auto;padding: 3px;">
                        @else
                ...
                <div class="row pt-3 pb-4">
                    <div class="col-md-5 offset-md-3">
                        <form class="form-horizontal" action="{{ route('module.team.update',$team->id) }}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Name</label>
                                <div class="col-sm-9">
                                    <input value="{{ $team->name }}" name="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Name">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input value="{{ $team->designation }}" name="designation" type="text" class="form-control @error('designation') is-invalid @enderror" placeholder="Enter Designation ">
