            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('msg.categoryedit') }}</h3>
                        ...
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('module.category.update', $category->id) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <img src="{{ asset($category->image) }}" height="80px" width="80px" alt="image">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">{{ __('msg.image') }}</label>
                                ...
                                <div class="form-group row">
                                    <div class="offset-sm-3 col-sm-4">
                                        <button type="submit" class="btn btn-success"><i
                                                class="fas fa-sync"></i>&nbsp;{{ __('msg.update') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
