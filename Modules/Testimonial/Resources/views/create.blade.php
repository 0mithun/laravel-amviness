            ...
            <div class="card">
                ...
                <div class="row pt-3 pb-4">
                    <div class="col-md-5 offset-md-3">
                        <form class="form-horizontal" action="{{ route('module.testimonial.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input value="{{ old('position') }}" name="position" type="text" class="form-control @error('position') is-invalid @enderror" placeholder="Enter Position">
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="editor2" type="text" class="form-control" name="description" placeholder="Write description of testimonial... ">{{ old('description') }}</textarea>
