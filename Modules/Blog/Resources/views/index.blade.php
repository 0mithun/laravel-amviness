...
@section('title') Post List | Admin @endsection
@section('content')
                                        ...
                                        <thead>
                                            <tr role="row" class="text-center">
                                                ...
                                                <th class="sorting_desc" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Rendering engine: activate to sort column ascending"
                                                    aria-sort="descending" width="15%">Category</th>
                                                <th class="sorting_desc" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Rendering engine: activate to sort column ascending"
                                                    aria-sort="descending" width="25%">Tags</th>
                                                <th class="sorting_desc" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Rendering engine: activate to sort column ascending"
                                            ...
                                            @foreach ($posts as $post)
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1 text-center" tabindex="0"><img width="50px"
                                                            height="50px" class="rounded" src="{{ asset($post->image) }}"
                                                            alt=""></td>
                                                    ...
                                                    <td class="sorting_1 text-center" tabindex="0">{!! $post->short_description !!}
                                                    </td>
                                                    <td class="sorting_1 text-center" tabindex="0">
                                                        ...
                                                        <form action="{{ route('module.post.destroy', $post->id) }}"
