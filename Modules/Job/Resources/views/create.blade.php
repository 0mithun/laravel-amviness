...
@section('title') Create Job | Admin @endsection
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">Create Job</h3>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-10 offset-md-1">
                            <form class="form-horizontal" action="{{ route('module.job.store') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('website_link') }}" name="website_link" type="text"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('map_address') }}" name="map_address" type="text"
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <select name="job_type" class="form-control">
                                                <option {{ old('job_type') == 'Full Time' ? 'selected' : '' }}
                                                    value="Full Time">Full Time</option>
                                                <option {{ old('job_type') == 'Half Time' ? 'selected' : '' }}
                                                    value="Half Time">Half Time</option>
                                                <option {{ old('job_type') == 'Remote' ? 'selected' : '' }}
                                                    value="Remote">
                                                    Remote</option>
                                            </select>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label class="form-label">Salary Range <span
                                                    class="text-danger">*</span></label>
                                            <input value="{{ old('salary_range') }}" name="salary_range" type="text"
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('education') }}" name="education" type="text"
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('experience') }}" name="experience" type="text"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="gender" id="" class="form-control">
                                                <option {{ old('gender') == 'Both' ? 'selected' : '' }} value="Both">Both
                                                </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="reservation" value="{{ old('expired_at') }}" name="expired_at"
