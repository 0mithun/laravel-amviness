...
@section('title') Tag List | Admin @endsection
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">Tag List</h3>
                        <a href="{{ route('module.tag.create') }}"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                                        ...
                                        <thead>
                                            <tr role="row" class="text-center">
                                                ...
                                                <th class="sorting_desc" tabindex="0" aria-controls="example1" rowspan="1"
                                                    ...
                                                    aria-sort="descending">Tag Name</th>
                                        ...
                                        <tbody>
                                            @foreach ($tags as $tag)
                                                <tr id="item_id{{ $tag->id }}" role="row" class="odd">
                                                    <td><input onchange="checked_count()" id="single_checkbox_category"
                                                            name="single_category_checkbox" value="{{ $tag->id }}"
                                                            type="checkbox"></td>
                                                    <td class="sorting_1 text-center" tabindex="0">{{ $tag->name }}</td>
                                                    <td class="sorting_1 text-center" tabindex="0">
                                                        <a data-toggle="tooltip" data-placement="top" title="Edit Tag"
                                                            href="{{ route('module.tag.edit', $tag->id) }}"
        ...
        function checked_count() {
            ...
            if (checked_length != 0) {
                ...
                $('#selected_item_delete').click(function(e) {
                    ...
                    $.ajax({
                        url: '{{ route('module.tag.multiple.destroy') }}',
                        type: 'DELETE',
                        data: {
                            id: ids,
                        },
